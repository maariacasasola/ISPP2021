...
describe('ComplaintAppealDialogComponent', () => {
  ...
  class mockComplaintsService {
    public create_complaint_appeal_complaint() {
      return of({
        ...
        content: "El retraso fue causado por necesidades personales, suelo ser puntual",
        checked: false
      })
    }
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [{ provide: MAT_DIALOG_DATA, useValue: '' }, { provide: MatDialogRef, useValue: mockDialogRef }, { provide: ComplaintAppealsService, useClass: mockComplaintsService }],
    }).compileComponents();
  });
