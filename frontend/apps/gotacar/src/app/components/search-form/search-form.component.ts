...
export class SearchFormComponent {
  ...
  constructor(private _snackBar: MatSnackBar, private fb: FormBuilder, private geocodeService: GeocoderServiceService) { 
  ...
  async get_origin() {
    ...
    try {
      ...
      if (cond1 || cond2 || cond3) {
        ...
        this.openSnackBar('Solo trabajamos con localizaciones de Sevilla', 'Introduzca de nuevo el origen');
      }
  ...
  async get_target() {
    try {
      ...
      if (cond1 || cond2 || cond3) {
        ...
        this.openSnackBar('Solo trabajamos con localizaciones de Sevilla', 'Introduzca de nuevo el destino');
      }
