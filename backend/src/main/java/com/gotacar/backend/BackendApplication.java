...
public class BackendApplication implements CommandLineRunner {
        ...
        private void loadSampleDate() {
                ...
                User driver = new User("Jesús", "Márquez", "h9HmVQqlBQXD289O8t8q7aN2Gzg1", "driver@gotacar.es",
                                "89070310K", "http://dnidriver.com", fecha3, lista3);
                ...
                User driver3 = new User("Marina", "Chacón", "h9HmVQqlBQXD289O8t8q7aN2Gzg3", "driver3@gmail.com",
                                "312412412J", "http://dnidriver.com", fecha1, lista3);
                ...
                User client2 = new User("Paloma", "Pérez", "oQfGQi4xechNkcQEdHg29sM5rP33", "client2@gotacar.com",
                ...
                // TRIPS
                // -----------------------------------------------------------------------------------------
                Location location1 = new Location("Cerro del Águila", "Calle Canal 48", -5.96211306033204,
                                37.37536809507917);
                Location location2 = new Location("Viapol", "Av. Diego Martínez Barrio", -5.976345387146261,
                                37.37625144174958);
                Location location3 = new Location("Triana", "Calle Reyes Católicos, 5, 41001 Sevilla",
                                -5.999724275498323, 37.38919329738635);
                Location location4 = new Location("Torneo", "41015, Torneo, Sevilla", -6.000865415980872,
                                37.397905288097164);
                Location location5 = new Location("Heliópolis", "Av. de la Palmera, 41013 Sevilla", -5.9799303283997,
                                37.355909980568825);
                Location location6 = new Location("Reina Mercedes", "Av. Reina Mercedes, Facultad de Informática",
                                -5.986327861966737, 37.35832075681644);
                Location location7 = new Location("Puerta Jerez", "Paseo de Roma, 33, 41013 Sevilla",
                                -5.9938026174584484, 37.38094298983268);
                Location location8 = new Location("Lagoh", "Av. de Palmas Altas, 1, 41012 Sevilla", -5.987332644990308,
                                37.34260576245235);
