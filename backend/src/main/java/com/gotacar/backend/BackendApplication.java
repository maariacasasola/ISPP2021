...
public class BackendApplication implements CommandLineRunner {
	...
	private void loadSampleDate() {
		...
		Location location5 = new Location("Heliópolis", "Av. de la Palmera, 41013 Sevilla", 37.355909980568825, -5.9799303283997);
		Location location6 = new Location("Reina Mercedes", "Av. Reina Mercedes, Facultad de Informática", 37.35832075681644, -5.986327861966737);
		Location location7 = new Location("Puerta Jerez", "Paseo de Roma, 33, 41013 Sevilla", 37.38094298983268, -5.9938026174584484);
		Location location8 = new Location("Lagoh", "Av. de Palmas Altas, 1, 41012 Sevilla", 37.34260576245235, -5.987332644990308);
