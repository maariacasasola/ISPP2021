...
public class BackendApplication implements CommandLineRunner {
        ...
        private void loadSampleData() {
                ...
                var fecha1 = LocalDate.of(1999, 10, 10);
                var fecha2 = LocalDate.of(2000, 11, 20);
                var fecha3 = LocalDate.of(2001, 12, 30);

                // Admin
                var admin = new User("Antonio", "Fernández", "jZ1JViuU0ec4d9nuW7R6d5FGCzw2", "admin@gotacar.es",
                                "89070360G", null, fecha3, lista1, "655757566");

                userRepository.save(admin);

                // Drivers
                var driver = new User("Jesús", "Márquez", "h9HmVQqlBQXD289O8t8q7aN2Gzg1", "driver@gotacar.es",
                                "89070310K", null, fecha3, lista3, "645454514");
                                
                var driver2 = new User("Manuel", "Fernández", "59t8UjqwHhWafrmdI3ZzpmHdod02", "driver2@gmail.com",
                                "312312312R", null, fecha1, lista3, "645054554",
                                LocalDateTime.of(2021, 06, 04, 13, 30, 24));
                var driver3 = new User("Marina", "Chacón", "BwhK9BAP8Vb9Sz6YCVbceXRCE713", "driver3@gmail.com",
                ...
                // Clients
                var client = new User("Martín", "Romero", "trKzninltQNh75RemITKB8tBIjY2", "client@gotacar.es",
                                "89070336D", null, fecha3, lista2, "656473627");
                var client2 = new User("Paloma", "Pérez", "UnlwXau8gSWzK8SwGe0zBzX6aSm2", "client2@gotacar.com",
                                "42131220T", null, fecha2, lista2, "656473147");
                var client3 = new User("Blanca", "Ruíz", "glqfC1lpaBWc7pqFa0lnYb0pQvE2", "client3@gotacar.es",
                                "89070345D", null, fecha1, lista2, "656493647");
                var client4 = new User("Alberto", "Suárez", "qG6h1Pc4DLbPTTTKmXdSxIMEUUE4", "client4@gotacar.com",
                                "42131225F", "http://dniclien4t.com", fecha2, lista2, "656473647");
                var client5 = new User("Salvador", "Luque", "qG6h1Pc4DLbPTTTKmXdSxIMEUUE5", "client5@gotacar.es",
                                "89070678S", null, fecha3, lista2, "656073647");
                var client6 = new User("María", "Sánchez", "qG6h1Pc4DLbPTTTKmXdSxIMEUUE6", "client6@gotacar.com",
                                "35131220T", null, fecha1, lista2, "656422647");
                var client7 = new User("Laura", "Muñoz", "qG6h1Pc4DLbPTTTKmXdSxIMEUUE7", "clien7@gotacar.es",
                                "80270336K", null, fecha3, lista2, "656473445");
                var client8 = new User("Pedro", "Serrano", "oQfGQi4xechNkcQEdHg29sM5rP33", "client8@gotacar.com",
                                "42941220L", null, fecha2, lista2, "651473647");
                var client9 = new User("Pedro", "Serrano", "2Sg1OCgPB8YoKjxgocXRJDtcvDo2", "client@gotacar.com",
                ...
                // MEETING POINTS
                // -----------------------------------------------------------------------------------------
                var meetingPoint1 = new MeetingPoint(37.37722160408209, -5.9871317313950705,
                                "41013, Plaza de España, Sevilla", "Plaza de España");
                var meetingPoint2 = new MeetingPoint(37.42663376216525, -5.978099088991483,
                                "41015, Torneo, Sevilla", "Torneo");
                var meetingPoint3 = new MeetingPoint(37.38919329738635, -5.999724275498323,
                                "Calle Reyes Católicos, 5, 41001 Sevilla", "Puerta de Triana");
                var meetingPoint4 = new MeetingPoint(37.37625144174958, -5.976345387146261,
                                "Av. de Diego Martínez Barrio, 4, 41013 Sevilla", "Viapol Center");
                var meetingPoint5 = new MeetingPoint(37.355909980568825, -5.9799303283997,
                                "Av. de la Palmera, 41013 Sevilla", "Heliópolis");
                var meetingPoint6 = new MeetingPoint(37.42556002644737, -5.972137193244373,
                ...
                // TRIPS
                // -----------------------------------------------------------------------------------------
                var location1 = new Location("Cerro del Águila", "Calle Canal 48", 37.37536809507917,
                                -5.96211306033204);
                var location2 = new Location("Viapol", "Av. Diego Martínez Barrio", 37.37625144174958,
                                -5.976345387146261);
                var location3 = new Location("Triana", "Calle Reyes Católicos, 5, 41001 Sevilla",
                                37.38919329738635, -5.999724275498323);
                var location4 = new Location("Torneo", "41015, Torneo, Sevilla", 37.397905288097164,
                                -6.000865415980872);
                var location5 = new Location("Heliópolis", "Av. de la Palmera, 41013 Sevilla", 37.355909980568825,
                                -5.9799303283997);
                var location6 = new Location("Reina Mercedes", "Av. Reina Mercedes, Facultad de Informática",
                                37.35832075681644, -5.986327861966737);
                var location7 = new Location("Puerta Jerez", "Paseo de Roma, 33, 41013 Sevilla", 37.38094298983268,
                                -5.9938026174584484);
                var location8 = new Location("Lagoh", "Av. de Palmas Altas, 1, 41012 Sevilla", 37.34260576245235,
                                -5.987332644990308);

                var fecha4 = LocalDateTime.of(2024, 02, 28, 13, 30, 24);
                var fecha5 = LocalDateTime.of(2024, 02, 28, 13, 36, 24);
                var fecha6 = LocalDateTime.of(2021, 05, 24, 16, 00, 00);
                var fecha7 = LocalDateTime.of(2021, 05, 24, 16, 15, 00);
                var fecha8 = LocalDateTime.of(2021, 05, 20, 17, 00, 00);
                var fecha9 = LocalDateTime.of(2021, 05, 20, 17, 21, 00);
                var fecha10 = LocalDateTime.of(2021, 03, 21, 12, 00, 00);
                var fecha11 = LocalDateTime.of(2021, 03, 21, 12, 40, 00);

                var trip1 = new Trip(location1, location3, 220, fecha6, fecha7,
                                "Viaje desde Cerro del Águila hasta Triana", 3, driver);
                var trip2 = new Trip(location2, location5, 220, fecha6, fecha7, "Viaje desde Viapol hasta Heliópolis",
                                3, driver2);
                var trip3 = new Trip(location1, location6, 200, fecha6, fecha7,
                                "Viaje desde Cerro del Águila hasta Reina Mercedes", 2, driver3);
                var trip4 = new Trip(location3, location4, 300, fecha4, fecha5, "Viaje desde Triana hasta Torneo", 3,
                                driver3);
                var trip5 = new Trip(location3, location4, 250, fecha4, fecha5, "Viaje desde Triana hasta Torneo", 2,
                                driver2);
                var trip6 = new Trip(location7, location8, 400, fecha8, fecha9, "Viaje desde Puerta Jerez hasta Reina",
                                5, driver);
                var trip7 = new Trip(location6, location4, 400, fecha8, fecha9,
                                "Viaje desde Reina Mercedes hasta Torneo", 2, driver2);
                var trip8 = new Trip(location4, location8, 450, fecha10, fecha11, "Viaje desde Torneo hasta Lagoh", 3,
                                driver);
                var trip9 = new Trip(location4, location8, 450, fecha10, fecha11,
                                "Viaje desde Torneo hasta Campo del Betis", 3, driver);
                var trip10 = new Trip(location4, location8, 450, fecha10, fecha11,
                ...
                // TRIP ORDERS
                // -----------------------------------------------------------------------------------------
                var tripOrder1 = new TripOrder(trip6, client, LocalDateTime.of(2021, 03, 20, 11, 45, 00), 400, "",
                                1);
                var tripOrder2 = new TripOrder(trip6, client2, LocalDateTime.of(2021, 03, 20, 11, 40, 00), 700,
                                "", 2);
                var tripOrder3 = new TripOrder(trip7, client3, LocalDateTime.of(2021, 03, 20, 14, 46, 37), 400,
                                "", 1);
                var tripOrder4 = new TripOrder(trip7, client5, LocalDateTime.of(2021, 03, 20, 15, 29, 25), 400,
                                "", 1);
                var tripOrder5 = new TripOrder(trip8, client4, LocalDateTime.of(2021, 03, 21, 10, 57, 42), 450,
                                "", 1);
                var tripOrder6 = new TripOrder(trip8, client7, LocalDateTime.of(2021, 03, 21, 11, 17, 28), 900,
                                "", 2);
                var tripOrder7 = new TripOrder(trip6, client6, LocalDateTime.of(2021, 03, 20, 16, 57, 42), 350,
                                "", 1);
                var tripOrder8 = new TripOrder(trip6, client8, LocalDateTime.of(2021, 03, 20, 11, 37, 16), 350,
                                "", 1);
                var tripOrder9 = new TripOrder(trip8, client3, LocalDateTime.of(2021, 03, 21, 11, 50, 52), 450,
                                "", 1);
                var tripOrder10 = new TripOrder(trip1, client5, LocalDateTime.of(2021, 03, 24, 11, 30, 22), 440,
                                "", 2);
                var tripOrder11 = new TripOrder(trip2, client8, LocalDateTime.of(2021, 03, 24, 20, 33, 27), 220,
                                "", 1);
                var tripOrder12 = new TripOrder(trip3, client, LocalDateTime.of(2021, 03, 24, 17, 35, 22), 400,
                                "", 2);
                var tripOrder13 = new TripOrder(trip2, client7, LocalDateTime.of(2021, 03, 24, 22, 50, 03), 220,
                                "", 1);
                var tripOrder14 = new TripOrder(trip4, driver, LocalDateTime.of(2021, 03, 24, 23, 46, 32), 300,
                                "", 1);
                var tripOrder15 = new TripOrder(trip5, client2, LocalDateTime.of(2021, 03, 24, 11, 30, 22), 500,
                                "", 2);
                var tripOrder16 = new TripOrder(trip9, client, LocalDateTime.of(2021, 03, 24, 11, 30, 22), 500,
                                "", 2);
                var tripOrder17 = new TripOrder(trip10, client, LocalDateTime.of(2021, 03, 24, 11, 30, 22), 500,
                                "", 2);
                var tripOrder18 = new TripOrder(trip6, client3, LocalDateTime.of(2021, 03, 20, 11, 45, 00), 500,
                                "", 2);
                var tripOrder19 = new TripOrder(trip1, client3, LocalDateTime.of(2021, 05, 23, 11, 45, 00), 440,
                                "", 2);
                ...
                var complaint3 = new Complaint("Queja por mala educación", "El conductor ha sido desagradable",
                                trip7, client5, LocalDateTime.of(2021, 03, 20, 18, 00, 00), "ALREADY_RESOLVED");
                var complaint4 = new Complaint("Queja por retraso", "El conductor se ha retrasado 5 min", trip8,
                                client4, LocalDateTime.of(2021, 03, 21, 12, 30, 00), "REFUSED");
                var complaint5 = new Complaint("Queja por velocidad1", "El coche olía mal", trip6, client,
                                LocalDateTime.of(2021, 03, 20, 17, 45, 00));
                var complaint6 = new Complaint("Queja por velocidad2", "El coche tenía una rueda pinchada", trip7,
                                client, LocalDateTime.of(2021, 03, 20, 17, 45, 00));
                var complaint7 = new Complaint("Queja por velocidad3", "El conductor escuchaba Bad Gyal", trip8,
                                client, LocalDateTime.of(2021, 03, 20, 17, 45, 00));
                ...
                // COMPLAINT APPEALS
                // -----------------------------------------------------------------------------------------
                var complaintAppeal1 = new ComplaintAppeal(
                                "El retraso fue causado por necesidades personales, suelo ser puntual", false,
                                complaint2, driver2);
                var complaintAppeal2 = new ComplaintAppeal(
                                "El retraso fue causado por necesidades personales", true, complaint2, driver2);
                var complaintAppeal3 = new ComplaintAppeal("El retraso fue causado por necesidades", false,
                                complaint3, driver);
                ...
                var paymentReturn1 = new PaymentReturn(client, 150);
                var paymentReturn2 = new PaymentReturn(client2, 180);
                var paymentReturn3 = new PaymentReturn(client3, 200);
                ...
                var data = new CarData("carPlate", LocalDate.of(2017, 03, 20), "model", "color");
                ...
                var rating = new Rating(client, driver, "gola", 4, trip6);
