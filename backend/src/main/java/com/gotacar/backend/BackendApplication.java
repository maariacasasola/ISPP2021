...
public class BackendApplication implements CommandLineRunner {
    ...
    private void loadSampleDate() {
        ...
        // Admin
        User admin = new User("Antonio", "Fernández", "Ej7NpmWydRWMIg28mIypzsI4BgM2", "admin@gotacar.es", "89070360G",
                "http://dniadmin.com", fecha3, lista1);
        ...
        // Clients
        User client = new User("Martín", "Romero", "qG6h1Pc4DLbPTTTKmXdSxIMEUUE1", "client@gotacar.es", "89070336D",
                "http://dniclient.com", fecha3, lista2);
        User client2 = new User("Paloma", "Pérez", "qG6h1Pc4DLbPTTTKmXdSxIMEUUE2", "client2@gotacar.com", "42131220T",
                "http://dniclient.com", fecha2, lista2);
        User client3 = new User("Blanca", "Ruíz", "qG6h1Pc4DLbPTTTKmXdSxIMEUUE3", "client3@gotacar.es", "89070345D",
                "http://dniclient.com", fecha1, lista2);
        User client4 = new User("Alberto", "Suárez", "qG6h1Pc4DLbPTTTKmXdSxIMEUUE4", "client4@gotacar.com", "42131225F",
                "http://dniclient.com", fecha2, lista2);
        User client5 = new User("Salvador", "Luque", "qG6h1Pc4DLbPTTTKmXdSxIMEUUE5", "client5@gotacar.es", "89070678S",
                "http://dniclient.com", fecha3, lista2);
        User client6 = new User("María", "Sánchez", "qG6h1Pc4DLbPTTTKmXdSxIMEUUE6", "client6@gotacar.com", "35131220T",
                "http://dniclient.com", fecha1, lista2);
        User client7 = new User("Laura", "Muñoz", "qG6h1Pc4DLbPTTTKmXdSxIMEUUE7", "clien7@gotacar.es", "80270336K",
                "http://dniclient.com", fecha3, lista2);
        ...
        MeetingPoint meetingPoint6 = new MeetingPoint(37.42556002644737, -5.972137193244373, "Norte, 41015 Sevilla",
                "Pino Montano");
        ...
        // TRIPS
        // -----------------------------------------------------------------------------------------
        Location location1 = new Location("Cerro del Águila", "Calle Canal 48", -5.96211306033204, 37.37536809507917);
        Location location2 = new Location("Viapol", "Av. Diego Martínez Barrio", -5.976345387146261, 37.37625144174958);
        Location location3 = new Location("Triana", "Calle Reyes Católicos, 5, 41001 Sevilla", -5.999724275498323, 37.38919329738635);
        Location location4 = new Location("Torneo", "41015, Torneo, Sevilla", -6.000865415980872, 37.397905288097164);
        Location location5 = new Location("Heliópolis", "Av. de la Palmera, 41013 Sevilla", -5.9799303283997, 37.355909980568825);
        Location location6 = new Location("Reina Mercedes", "Av. Reina Mercedes, Facultad de Informática", -5.986327861966737, 37.35832075681644);
        Location location7 = new Location("Puerta Jerez", "Paseo de Roma, 33, 41013 Sevilla", -5.9938026174584484, 37.38094298983268);
        Location location8 = new Location("Lagoh", "Av. de Palmas Altas, 1, 41012 Sevilla", -5.987332644990308, 37.34260576245235);
        ...
        Trip trip1 = new Trip(location1, location3, 220, fecha6, fecha7, "Viaje desde Cerro del Águila hasta Triana", 3, driver);
        Trip trip2 = new Trip(location2, location5, 220, fecha6, fecha7, "Viaje desde Viapol hasta Heliópolis", 3, driver2);
        Trip trip3 = new Trip(location1, location6, 200, fecha6, fecha7, "Viaje desde Cerro del Águila hasta Reina Mercedes", 2, driver3);
