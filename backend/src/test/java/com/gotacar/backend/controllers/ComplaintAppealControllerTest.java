...
public class ComplaintAppealControllerTest {
        ...
        public void acceptComplaintAppealTestUser() throws Exception {
                ...
                ResultActions result = mockMvc
                                .perform(post("/complaint_appeals/{complaintAppealId}/accept", complaintAppealRepository.findAll().get(0).getId())
        ...
        public void rejectComplaintAppealTestUser() throws Exception {
                ...
                // Petición post al controlador
                ResultActions result = mockMvc
                                .perform(post("/complaint_appeals/{complaintAppealId}/reject", complaintAppealRepository.findAll().get(2).getId())
                                                .header("Authorization", token)
                                                .contentType(MediaType.APPLICATION_JSON));
