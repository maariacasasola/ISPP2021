...
class MeetingPointControllerTest {
        ...
        void setUp() {
                ...
                meetingPoint = new MeetingPoint(37.37722160408209, -5.9871317313950705,
        ...
        void testCreateMeetingPointUser() throws Exception {
                ...
                ResultActions result = mockMvc.perform(post("/create_meeting_point").header("Authorization", token)
        ...
        void testCreateMeetingPointAdmin() throws Exception {
                Mockito.when(meetingPointRepository.findByName("Heliopolis")).thenReturn(new MeetingPoint(
                                37.355465467940405, -5.982498103652494, "Calle Ifni, 41012 Sevilla", "Heliopolis"));
                ...
                assertThat(meetingPointRepository.findByName("Heliopolis").getAddress())
                                .isEqualTo("Calle Ifni, 41012 Sevilla");
        }
